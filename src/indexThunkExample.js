 ...
 const loggerMiddleware = (store) => {
    ...
    return (next) => {
       ...
       return (action) => {
         ...
         console.groupCollapsed("PRÉPARATION DISPATCH POUR " + action.type)
         console.log("Valeurs entrantes : ",action.payload)
...
store.dispatch({
 ...
 //La différence c'est que fetchSuggestions retourne une autre fonction
 //Donc le thunkMiddleware va faire en sorte de l'exécuter différement, de tel sorte
 //à avoir au final, bien un objet pour signaler un reducer 
 store.dispatch(fetchSuggestions("La"));